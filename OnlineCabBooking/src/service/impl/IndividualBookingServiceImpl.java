...
public class IndividualBookingServiceImpl implements IndividualBookingService {

	@Autowired
	private IndividualBookingMapper orderDataMapper;

	public IndividualBookingMapper getBookingOrder() {
		return orderDataMapper;
	}

	public void setBookingOrder(IndividualBookingMapper bookingOrder) {
		this.orderDataMapper = bookingOrder;
	}
	...
	public Map<String, Object> readOneOrder(int orderid) {
		...
		Order order_fullInfo = orderDataMapper.readOneOrder(order);
...
//		System.out.println("*********" + info.get("id"));
	...
	public Boolean updateOrder(Map<String, String> map) {
		...
		Boolean result = orderDataMapper.updateOrder(order);
	...
	public Boolean deleteOneOrder(int orderId) {
		...
		Order order = new Order();
		order.setOrderId(orderId);
		Boolean result = orderDataMapper.deleteOneOrder(order);
	...
	public int deleteOrders(String[] orderIds) {
		...
		int result = orderDataMapper.deleteOrders(orderids);
	...
	public List<Map<String, Object>> getOrdersInfo(int userid) {
		...
		List<Order> orders = orderDataMapper.getUserOrders(user);
	...
	public List<Map<String, Object>> getBusinessOrdersInfo(int userId) {
		...
		user.setUserId(userId);
		// get the list of orders
		List<Order> orders = orderDataMapper.getBusinessOrders(user);
		// retrieve the information
		List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
		if(orders == null) {
			return null;
