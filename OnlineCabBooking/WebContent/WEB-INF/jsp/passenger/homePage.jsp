...
<body>
	...
	<div class="container-fluid">
		...
		<br/>
		<a class="btn btn-outline-info" role="button" href="passenger/viewOrders.htm">View my orders</a> 
		<a class="btn btn-outline-info" role="button" href="#" onClick="editPageDialog(0)">Create one order</a>
