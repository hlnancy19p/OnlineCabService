...
function deleteOneOrder(orderId){
    ...
    var url="deleteOneEmplyeeOrder.htm";
...
function deleteOrders(){
    ...
    // use ajax to send params to back end and receive result
    var url="deleteEmployeeOrders.htm";
...
function viewOneOrder(orderId){
	...
	// use ajax to send params to back end and receive result
	var url="viewOneEmployeeOrder.htm";
	$.ajax({
		url : url,
		type : "POST",
		async : false,
...
function refreshOrders(){
	// use ajax to send params to back end and receive result
    var params = { };
    var url="businessOrdersList.htm";
	$.ajax({
		url : url,
		type : "GET",
		async : false,
...
//refresh list of orders to a specific employee
function employeeOrders(){
	var userId=$("#appliers").find("option:selected").val();
	// use ajax to send params to back end and receive result
    var params = { 
    		userId:userId
    };
